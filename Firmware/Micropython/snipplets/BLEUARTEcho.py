...
class BLEUARTEcho:
    """Nordic UART Service echo peripheral with a connection-driven LED."""

    def __init__(self, name="Pico-NUS", ble=None):
        # The advertised device name lives on the instance.
        self._name = name
